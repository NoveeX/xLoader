...
namespace ImGui
{
    ...
    IMGUI_API void          Custom_dark_red(ImGuiStyle* dst = NULL);
    IMGUI_API void          Custom_dark_green(ImGuiStyle* dst = NULL);
    IMGUI_API void          Custom_classic(ImGuiStyle* dst = NULL);
    IMGUI_API void          Custom_light_red(ImGuiStyle* dst = NULL);
    IMGUI_API void          Custom_light_green(ImGuiStyle* dst = NULL);
    IMGUI_API void          Custom_light_blue(ImGuiStyle* dst = NULL);
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0), bool border = false);   // button
