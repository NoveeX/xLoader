...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, bool border)
{
    ...
    if (border)RenderFrame(bb.Min, bb.Max, GetColorU32(ImGuiCol_Border), true, style.FrameRounding);
    RenderFrame(bb.Min + ImVec2(1, 1), bb.Max - ImVec2(1, 1), col, true, style.FrameRounding);
    
    // ImGui::GetBackgroundDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(ImGuiCol_Border));
    if (g.LogEnabled)
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    // Render shape
    const ImU32 frame_col = GetColorU32(hovered ? ImGuiCol_ChildBg : ImGuiCol_FrameBg);
